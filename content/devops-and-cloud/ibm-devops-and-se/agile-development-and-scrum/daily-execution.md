...
![Daily Execution](/notes/Daily%20Execution.png)
...
![Daily Execution](/notes/Daily%20Execution-1.png)
...
![Daily Execution](/notes/Daily%20Execution-2.png)
...
- [x] The accountabilities of product owner, development team(s) and Scrum master are identified and enacted
- [x] Work is organized in consecutive sprints of 2–4 weeks or fewer
- [x] There is a sprint backlog with a visualization of remaining work for the sprint
- [x] At sprint planning a forecast, a sprint backlog, and a sprint goal are created
- [x] The result of the daily Scrum is work being re-planned for the next day
- [x] No later than by the end of the sprint, a Done increment is created
- [x] Stakeholders offer feedback as a result of inspecting the increment at the sprint review
- [x] Product backlog is updated as a result of the sprint review
- [x] Product owner, development team(s) and Scrum master align on the work process for their next sprint at the sprint retrospective
